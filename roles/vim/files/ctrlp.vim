...
set wildignore+=*/tmp/*,*/CMakeFiles/*,*/dist/*,*/bin/*,*/build/*,*/target/*,*.so,*.swp,*.zip,*.exe,*/.tmp/*,*/.sass-cache/*,*/node_modules/*,*/jspm_packages/*,*.keep,*.DS_Store,*/.git/*,*/.svn/*,*/bower_components/*,*/*.xcodeproj/*,*/*.app/*,*.plist,*.xcconfig,*/.idea/*,*.o,*.d,*.out
