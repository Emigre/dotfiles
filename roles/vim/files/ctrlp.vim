...
set wildignore+=*/tmp/*,*/dist/*,*/build/*,*/target/*,*.so,*.swp,*.zip,*.exe,*/.tmp/*,*/.sass-cache/*,*/node_modules/*,*.keep,*.DS_Store,*/.git/*,*/.svn/*,*/bower_components/*,*/*.xcodeproj/*,*.plist,*.xcconfig,*/.idea/*,*.o,*.d,*.out
